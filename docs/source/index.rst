...
Hello Kodo
----------
Although we aim for high performance in Kodo we also strive for an easy-to-use
API to illustrate this, the following example shows how to encode and decode a
block of data.
...
Overview
--------
We have divided the documentation of Kodo into two parts one part for user that
are mostly interested in integrating and using the features of Kodo in an their
own projects, and one part for developers who are interested in contributing
code to Kodo library.
