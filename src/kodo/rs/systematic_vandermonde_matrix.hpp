...
namespace kodo
{
    ...
    template<class SuperCoder>
    systematic_vandermonde_matrix<SuperCoder>::factory::factory(
    ...
    template<class SuperCoder>
    inline auto
    systematic_vandermonde_matrix<SuperCoder>::factory::construct_matrix(
        uint32_t symbols) -> boost::shared_ptr<generator_matrix>
    {
        ...
        boost::shared_ptr<generator_matrix> m =
            Super::factory::construct_matrix(symbols);
